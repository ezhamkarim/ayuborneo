...
import 'package:ayuborneo/src/pdf/printer_provider.dart';
// import 'package:ayuborneo/src/pdf/pdf_view.dart';
    ...
    return AnimatedBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return MultiProvider(
          providers: [ChangeNotifierProvider(create: (c) => PrinterProvider())],
          child: MaterialApp(
              ...
              return MaterialPageRoute<void>(
                ...
                builder: (BuildContext context) {
                  ...
                  if (name.contains('.aspx')) {
                    var url = 'https://ayuborneo.x1.com.my$name';
                    final parsedUrl = Uri.parse(url);

                    log('URI : $parsedUrl');
                    return InternalPdfView(
                  ...
                  switch (name) {
                    ...
                    case ExamplePrinterView.routeName:
                      ...
                      var filePath = arguments['urlPDFPath'] as String?;
                      var pageSetting =
                          arguments['pageSettings'] as PdfPageSettings;
