...
class ExamplePrinterView extends StatefulWidget {
  const ExamplePrinterView({super.key, this.filePath});
...
class _ExamplePrinterViewState extends State<ExamplePrinterView> {
  ...
  Future _printReceiveTest() async {
    try {
      ...
      bytes += generator.setGlobalCodeTable(null);
      ...
      if (filePath == null) {
        ...
        if (context.mounted) {
          dialogWithOutActionWarning(context, 'Cant print');
        }
        return;
      }
      ...
      if (context.mounted) {
        dialogWithOutActionWarning(context, 'Cant print $e');
      }
    }
  }

  Future dialogWithOutActionWarning(
